...
# Test script for Team Recommender ML API (FastText)
# Assumes API is running on port 5002

BASE_URL="http://localhost:5002"

echo "========================================="
echo " Team Recommender ML API - Test Suite"
echo "========================================="
...
# Test 2: Recommend with frontend skills
echo -e "\n[2] Recommend teams for: react typescript nodejs..."
...
echo "Found $COUNT1 recommendations"

# Test 3: Recommend with backend skills
echo -e "\n[3] Recommend teams for: python django postgresql docker..."
REC2=$(curl -s -X POST "${BASE_URL}/ml/recommend" \
    -H "Content-Type: application/json" \
    -d '{"skills": "python django postgresql docker", "top_n": 5}')
...
# Test 4: Recommend with mobile skills
echo -e "\n[4] Recommend teams for: flutter dart firebase..."
...
echo -e "\n[5] Recommend teams for UNSEEN skills: langchain llamaindex vectordb..."
...
# Test 6: Empty skills
echo -e "\n[6] Recommend teams with empty skills..."
...
echo -e "\n========================================="
echo "✅ Team Recommender ML API Test Complete!"
echo "========================================="
